                    ...
                    <div className="row">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li><a href="shop.html" data-state="selected">Магазин</a></li>
                            ...
                            <div className="cart">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="8.3 0 105.5 126.1" preserveAspectRatio="xMinYMax meet" ng-switch-when="1">
                                    ...
                                    <text x="58.5" y="77" dy=".35em" text-anchor="middle" className="quantity" data-hook="cart-widget-items-count">0</text>
                                </svg>
                            </div>
                        </nav>
                    </div>
